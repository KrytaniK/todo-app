...
const C_List_NewTaskForm = ({onSubmit, onCancel, placeholderText}) => {
    return <form className="project-listTask-new flex-row" onSubmit={onSubmit}>
        ...
        <div className="project-listTask flex-row">
            <input type="text" id="taskNameInput" name="taskName" placeholder={placeholderText || 'New Task'} defaultValue={placeholderText || ''} aria-label="New Task Name Input" autoFocus={true} />
        </div>
    </form>
}
